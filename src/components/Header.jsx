...
function Header({ isNavOpen, setIsNavOpen, isLight, setIsLight, onSelectFeed }) {
    // Recarga la página (navegador) al activar la marca
    const handleBrandActivate = () => window.location.reload()
    ...
    // Icono del botón de tema (extraído del JSX para evitar el error de parseo)
            ...
            <header className="fs-header">
                ...
                <nav className="header-actions-desktop" aria-label="Atajos de escritorio">
                    <a
                        href="#tendencias"
                        className="link"
                        onClick={(e) => { e.preventDefault(); onSelectFeed && onSelectFeed('trending') }}
                    >
                        Tendencias
                    </a>
                    <a
                        ...
                        className="link"
                        onClick={(e) => { e.preventDefault(); onSelectFeed && onSelectFeed('top_rated') }}
                    >
                        Mejor valoradas
                    </a>
